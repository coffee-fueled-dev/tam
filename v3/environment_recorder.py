...
class JSONLEnvironmentRecorder(EnvironmentRecorder):
    ...
    def record(
        ...
        obstacles_changed = (self.previous_obstacles is None or 
                            obstacles_list != self.previous_obstacles)
        ...
        final_move_number = move_number if move_number is not None else self._current_move_number
