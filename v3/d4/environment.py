"""
Simple 4D environment implementation using the abstract Environment interface.
...
class Simple4DEnvironment(Environment):
    """
    Simple 4D point-mass environment with obstacles and goals.
    ...
    def __init__(
        ...
        """
        Initialize simple 4D environment.
        
        Args:
            state_dim: Dimension of state space (default: 4 for 4D)
        ...
        self.energy_per_unit_distance = 1.0
        self.is_dead = False
